...
<tr>
<td>
<input  placeholder="<?php echo $this->_var['lang']['email_address']; ?>"   name="email" type="text" class="inputBg"  id="email_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['email']); ?>" />
