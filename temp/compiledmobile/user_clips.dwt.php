...
<div class="login">
		...
		<header id="header">
			<div class="c-inav">
				...
				<section>
				<a class="c-btn" style=" background-color:#FFFFFF" href="index.php"><span>首页</span></a>
				</section>
			</div>
		</header>
        ...
        <section style="width:100%;margin:5px auto 0;overflow:hidden; background-color:#F4F4F4">
		  <div class="user">
			
			<div class="info">
			  <table width="100%">
			  <tbody><tr style="height:30px;"><td width="50%">用户名：<?php echo $this->_var['info']['username']; ?></td>
			  <td>级别:<?php echo $this->_var['rank_name']; ?></td></tr>
			  <tr style="height:30px;"><td>积分：<strong><?php echo $this->_var['info']['integral']; ?></strong></td>
			  <td>余额：<strong><?php echo $this->_var['info']['surplus']; ?></strong></td></tr>
			...
			<div class="account order">
			  ...
			  <ul>
				...
				<li> <a class="first" href="user.php?act=profile"><?php echo $this->_var['lang']['label_profile']; ?></a> <a class="link"><span class="more"><span class="inner"></span></span></a> </li>
				<li> <a href="user.php?act=address_list"><?php echo $this->_var['lang']['label_address']; ?></a> <a class="link"><span class="more"><span class="inner"></span></span></a> </li>
				<li> <a href="user.php?act=collection_list"><?php echo $this->_var['lang']['label_collection']; ?></a> <a class="link"><span class="more"><span class="inner"></span></span></a> </li>
				<li> <a href="user.php?act=message_list"><?php echo $this->_var['lang']['label_message']; ?></a> <a class="link"><span class="more"><span class="inner"></span></span></a> </li>
				<li> <a href="user.php?act=booking_list"><?php echo $this->_var['lang']['label_booking']; ?></a> <a class="link"><span class="more"><span class="inner"></span></span></a> </li>
				<li> <a href="user.php?act=bonus"><?php echo $this->_var['lang']['label_bonus']; ?></a> <a class="link"><span class="more"><span class="inner"></span></span></a> </li>
				<li> <a href="user.php?act=affiliate"><?php echo $this->_var['lang']['label_affiliate']; ?></a> <a class="link"><span class="more"><span class="inner"></span></span></a> </li>
				<li> <a href="user.php?act=comment_list"><?php echo $this->_var['lang']['label_comment']; ?></a> <a class="link"><span class="more"><span class="inner"></span></span></a> </li>
				<li> <a href="user.php?act=track_packages"><?php echo $this->_var['lang']['label_track_packages']; ?></a> <a class="link"><span class="more"><span class="inner"></span></span></a> </li>
				<li> <a href="user.php?act=account_log"><?php echo $this->_var['lang']['label_user_surplus']; ?></a> <a class="link"><span class="more"><span class="inner"></span></span></a> </li>
