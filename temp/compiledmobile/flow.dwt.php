...
<LINK rel=stylesheet type=text/css href="themes/default/css/com_cart.css">
<LINK rel=stylesheet type=text/css href="themes/default/css/com_style.css">
</head>
  ...
  <ul>
	...
	<?php if ($this->_var['goods_list']): ?>
		...
		<ul>
			...
			<img src="themes/default/images/com/step1.png">
			<li>确认订单</li>
			<img src="themes/default/images/com/step2.png">
			<li>购买成功</li>
		</ul>
		</div>
		<div class="bcont">
...
?>
									...
									<?php endif; ?>
										...
										<?php endif; ?>
											<div class="price"><em class="h subtotal" tprice="19.00"><?php echo $this->_var['goods']['goods_price']; ?></em> 
											<?php if ($this->_var['show_marketprice']): ?>
											<del class="grey"> 
											<?php echo $this->_var['goods']['market_price']; ?> 
											</del> 
											<?php endif; ?>
												<div class="quantity"><span class="txt" style="width:70px"> 
												<?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['is_gift'] == 0 && $this->_var['goods']['parent_id'] == 0): ?>
												<table>
												<tr>
												<td><a href="javascript:;" onClick="red_num(<?php echo $this->_var['goods']['rec_id']; ?>,<?php echo $this->_var['goods']['goods_id']; ?>);" title="减少数量" style="font-size:16px; color: #000; cursor:pointer">-</a></td>
												<td><input class="c-f-text qt" type="text" name="goods_number[<?php echo $this->_var['goods']['rec_id']; ?>]" id="goods_number_<?php echo $this->_var['goods']['rec_id']; ?>" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="4"   onkeyup="changenum(<?php echo $this->_var['goods']['rec_id']; ?>)"/></td>
												<td><a href="javascript:;" onClick="add_num(<?php echo $this->_var['goods']['rec_id']; ?>,<?php echo $this->_var['goods']['goods_id']; ?>)" title="增加数量" style="font-size:16px; color: #000; cursor:pointer">+</a></td>
												</tr>
												</table>
...
<div class="toolbar" style="height: 40px; position: fixed"><div class="totalprice"><p>合计: <em class="h price" id="goods_subtotal"><?php echo $this->_var['total']['goods_price']; ?></em></p>
<a style="display:block; text-align:center; line-height:40px; background-color:#FF9F34" class="c-btn-orgn c-btn-sub"  href="flow.php?step=checkout">结算(<em class="num" id="total_number"><?php echo $this->_var['total']['total_number']; ?></em>)</a>
</div>
</div>
...
?>
		...
		<div id="J_plugin_cart">
			...
			<ul>
				<li>购物车列表</li>
				<img src="themes/default/images/com/step3.png">
...
?>
	...
	<section class="order on"> 
		<div class="shop"> 
		<div class="title"> 
		<div class="info"><h3><?php echo $this->_var['lang']['other_info']; ?></h3> </div>  
		</div> 
		</div>
    ...
    <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="" id="paymentTable">
	        <tr>
              ...
              <th width="20%" bgcolor="" style=" text-align:left"></th>
             
              <th bgcolor=""  style=" text-align:center"></th>
            </tr>
            <?php if ($this->_var['allow_use_surplus']): ?>
            <tr>
              <td width="20%" bgcolor="" style="padding-left:5px"><strong><?php echo $this->_var['lang']['use_surplus']; ?>: </strong></td>
              <td bgcolor=""><input name="surplus" type="text" style="width:50%" class="inputBg" id="ECS_SURPLUS" size="10" value="<?php echo empty($this->_var['order']['surplus']) ? '0' : $this->_var['order']['surplus']; ?>" onblur="changeSurplus(this.value)" <?php if ($this->_var['disable_surplus']): ?>disabled="disabled"<?php endif; ?> />
            ...
            <tr>
              <td bgcolor="" style="padding-left:5px"><strong><?php echo $this->_var['lang']['use_integral']; ?></strong></td>
              <td bgcolor=""><input name="integral" type="text" class="inputBg" style="width:50%" id="ECS_INTEGRAL" onblur="changeIntegral(this.value)" value="<?php echo empty($this->_var['order']['integral']) ? '0' : $this->_var['order']['integral']; ?>" size="10" />
        ...
        <?php endif; ?>
            ...
            <tr>
              <td bgcolor="" width="20%" style="padding-left:5px"><strong><?php echo $this->_var['lang']['use_bonus']; ?>:</strong></td>
              <td bgcolor="">
...
?>
                ...
                <input name="bonus_sn" type="text" class="inputBg" size="15" value="<?php echo $this->_var['order']['bonus_sn']; ?>" style="width:60%; margin-top:5px" />
            ...
            <tr>
              <td bgcolor="" style="padding-left:5px"><strong><?php echo $this->_var['lang']['invoice']; ?>:</strong>
            ...
            <?php endif; ?>
            <tr>
              <td valign="top" bgcolor="" style="padding-left:5px"><strong><?php echo $this->_var['lang']['order_postscript']; ?>:</strong></td>
              <td bgcolor=""><textarea name="postscript" cols="80" rows="3" id="postscript" style="border:1px solid #ccc; width:95%"><?php echo htmlspecialchars($this->_var['order']['postscript']); ?></textarea></td>
            </tr>
            <?php if ($this->_var['how_oos_list']): ?>
            <tr>
              <td bgcolor="" style="padding-left:5px"><strong><?php echo $this->_var['lang']['booking_process']; ?>:</strong></td>
              <td bgcolor=""><?php $_from = $this->_var['how_oos_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('how_oos_id', 'how_oos_name');if (count($_from)):
...
?>
                ...
                <?php echo $this->_var['how_oos_name']; ?></label><br>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
              </td>
            </tr>
            <?php endif; ?>
