...
<link href="themes/default/css/com_style.css" rel="stylesheet" type="text/css" />
<link href="themes/default/css/com_user.css" rel="stylesheet" type="text/css" />
...
function wxch_pay()
{
	...
	WeixinJSBridge.invoke('getBrandWCPayRequest',<?php echo $this->_var['create_wxpay']; ?>,function(res){
	WeixinJSBridge.log(res.err_msg);
        ...
        {
           alert('支付成功');  
//           window.location.href="<?php echo $this->_var['notify_url']; ?>"
        }
        if(pay_msg == 'cancel')
        {
           alert('取消支付');  
...
?>
		...
		<header id="header">
			<div class="c-inav">
				<section>
					...
					<section>
					<span style="font-size:14px; color:#333; font-weight:normal"><?php echo $this->_var['lang']['profile']; ?></span>
				</section>
				<section></section>
			</div>
		</header>
     ...
     <form name="formEdit" action="user.php" method="post" onSubmit="return userEdit()">
      <table width="100%" border="0" cellpadding="5" cellspacing="1" >
                <tr>
                  <td colspan="2" align="left" >   <?php echo $this->html_select_date(array('field_order'=>'YMD','prefix'=>'birthday','start_year'=>'-60','end_year'=>'+1','display_days'=>'true','month_format'=>'%m','day_value_format'=>'%02d','time'=>$this->_var['profile']['birthday'])); ?> </td>
                </tr>
                <tr>
                  <td colspan="2" align="left" >  <input type="radio" name="sex" value="0" <?php if ($this->_var['profile']['sex'] == 0): ?>checked="checked"<?php endif; ?> />
  <?php echo $this->_var['lang']['secrecy']; ?>&nbsp;&nbsp;
                ...
                <tr>
                  ...
                  <td colspan="2"  align="left" ><input name="email" type="text" value="<?php echo $this->_var['profile']['email']; ?>" size="25" class="inputBg" /><span style="color:#FF0000"> *</span></td>
                </tr>
...
?>
		...
		<tr>
		  ...
		  <td   colspan="2" align="left"<?php if ($this->_var['field']['is_need']): ?>id="passwd_quesetion"<?php endif; ?>>
		  <input  placeholder="<?php echo $this->_var['lang']['passwd_answer']; ?>"   name="passwd_answer" type="text" size="25" class="inputBg" maxlengt='20' value="<?php echo $this->_var['profile']['passwd_answer']; ?>"/><?php if ($this->_var['field']['is_need']): ?> <?php endif; ?>		  </td>
		</tr>
		<?php else: ?>
		<tr>
		 
			<td  colspan="2"  align="left"  <?php if ($this->_var['field']['is_need']): ?>id="extend_field<?php echo $this->_var['field']['id']; ?>i"<?php endif; ?>>
			<input placeholder="<?php echo $this->_var['field']['reg_field_name']; ?>"  name="extend_field<?php echo $this->_var['field']['id']; ?>" type="text" class="inputBg" value="<?php echo $this->_var['field']['content']; ?>"/><?php if ($this->_var['field']['is_need']): ?><span style="color:#FF0000"> *</span><?php endif; ?>			</td>
		</tr>
		<?php endif; ?>
		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                <tr>
                  <td colspan="2" align="center"><input name="act" type="hidden" value="act_edit_profile" />
                    <input name="submit" type="submit" value="<?php echo $this->_var['lang']['confirm_edit']; ?>" class="c-btn"   />                  </td>
                </tr>
       </table>
    </form>
     ...
     <table width="100%" border="0" cellpadding="5" cellspacing="1">
        <tr>
          ...
          <td colspan="2"  align="left" ><input  placeholder="<?php echo $this->_var['lang']['old_password']; ?>" name="old_password" type="password" size="25"  class="inputBg" /></td>
        </tr>
        <tr>
     
          <td colspan="2"  align="left" ><input placeholder="<?php echo $this->_var['lang']['new_password']; ?>" name="new_password" type="password" size="25"  class="inputBg" /></td>
        </tr>
        <tr>
   
          <td colspan="2"  align="left" ><input placeholder="<?php echo $this->_var['lang']['confirm_password']; ?>" name="comfirm_password" type="password" size="25"  class="inputBg" /></td>
        </tr>
        <tr>
          <td colspan="2" align="center" ><input name="act" type="hidden" value="act_edit_password" />
            <input name="submit" type="submit" class="c-btn"  value="<?php echo $this->_var['lang']['confirm_edit']; ?>" />
          </td>
        </tr>
      </table>
    </form>
	  ...
	  <header id="header">
			<div class="c-inav">
				<section>
					...
					<section>
					<span style="font-size:14px; color:#333; font-weight:normal"><?php echo $this->_var['lang']['label_bonus']; ?></span>
				</section>
				<section></section>
			</div>
		</header>
      ...
      <div class="blank"></div>
       <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
        <tr>
          ...
          <th align="center" bgcolor="#FFFFFF">最小订单</th>
          <th align="center" bgcolor="#FFFFFF">截止日期</th>
...
?>
      ...
      <form name="addBouns" action="user.php" method="post" onSubmit="return addBonus()">
          ...
          <input  placeholder=" <?php echo $this->_var['lang']['bonus_number']; ?>" name="bonus_sn" type="text"   class="inputBg" />
          <input type="hidden" name="act" value="act_add_bonus" class="inputBg" />
		  
		  <div class="blank"></div>
          <input type="submit" class="c-btn"   value="<?php echo $this->_var['lang']['add_bonus']; ?>" />
	    ...
	    <header id="header">
			<div class="c-inav">
				<section>
					...
					<section>
					<span style="font-size:14px; color:#333; font-weight:normal"><?php echo $this->_var['lang']['label_order']; ?></span>
				</section>
				<section></section>
			</div>
		</header>
        ...
        <form action="user.php" method="post" name="formOrder" onsubmit="return mergeOrder()">
          <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              ...
              <input type="submit" name="Submit"  class="c-btn"  value="<?php echo $this->_var['lang']['merge_order']; ?>" /></td>
            </tr>
            <tr>
	  ...
	  <header id="header">
			<div class="c-inav">
				<section>
					...
					<section>
					<span style="font-size:14px; color:#333; font-weight:normal"><?php echo $this->_var['lang']['label_track_packages']; ?></span>
				</section>
				<section></section>
			</div>
		</header>
...
?>
      ...
      <?php if ($this->_var['action'] == order_detail): ?>
	    ...
	    <header id="header">
			<div class="c-inav">
				<section>
					...
					<section>
					<span style="font-size:14px; color:#333; font-weight:normal"><?php echo $this->_var['lang']['order_status']; ?></span>
				</section>
				<section></section>
			</div>
		</header>
        ...
        <div class="blank"></div>
         <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
        <tr>
          <td width="25%" align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['detail_order_sn']; ?>：</td>
        ...
        <tr>
          <td align="center" bgcolor="#ffffff"><?php echo $this->_var['lang']['detail_order_status']; ?>：</td>
          <td align="center" bgcolor="#ffffff"><?php echo $this->_var['order']['order_status']; ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_var['order']['confirm_time']; ?></td>
        </tr>
        <tr>
          <td align="center" bgcolor="#ffffff"><?php echo $this->_var['lang']['detail_pay_status']; ?>：</td>
          <td align="center" bgcolor="#ffffff"><?php echo $this->_var['order']['pay_status']; ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php if ($this->_var['order']['order_amount'] > 0): ?><?php echo $this->_var['order']['pay_online']; ?><?php endif; ?><?php echo $this->_var['order']['pay_time']; ?></td>
        </tr>
        <tr>
          <td align="center" bgcolor="#ffffff"><?php echo $this->_var['lang']['detail_shipping_status']; ?>：</td>
          <td align="center" bgcolor="#ffffff"><?php echo $this->_var['order']['shipping_status']; ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_var['order']['shipping_time']; ?></td>
        </tr>
        <?php if ($this->_var['order']['invoice_no']): ?>
        <tr>
          <td align="center" bgcolor="#ffffff"><?php echo $this->_var['lang']['consignment']; ?>：</td>
          <td align="center" bgcolor="#ffffff"><?php echo $this->_var['order']['invoice_no']; ?></td>
        </tr>
        <?php endif; ?>
        <?php if ($this->_var['order']['to_buyer']): ?>
        <tr>
          <td align="center" bgcolor="#ffffff"><?php echo $this->_var['lang']['detail_to_buyer']; ?>：</td>
          <td align="center" bgcolor="#ffffff"><?php echo $this->_var['order']['to_buyer']; ?></td>
        </tr>
        <?php endif; ?>

        <?php if ($this->_var['virtual_card']): ?>
        <tr>
          <td align="center" bgcolor="#ffffff"><?php echo $this->_var['lang']['virtual_card_info']; ?>：</td>
        ...
        <div class="blank"></div>
         <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr>
            ...
            <th width="9%" align="center" bgcolor="#ffffff">数量</th>
        ...
        <div class="blank"></div>
         <?php if ($this->_var['order']['allow_update_address'] > 0): ?>
          <form action="user.php" method="post" name="formAddress" id="formAddress">
           <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
              <tr>
                <td align="left" bgcolor="#ffffff"><?php echo $this->_var['lang']['consignee_name']; ?>： 
				<br/>
				<input name="consignee" type="text"  class="inputBg" value="<?php echo htmlspecialchars($this->_var['order']['consignee']); ?>" size="25">
                </td>
				</tr>
				 <tr>
                <td align="left" bgcolor="#ffffff">
				<?php echo $this->_var['lang']['email_address']; ?>： 
				<br/>
				<input name="email" type="text"  class="inputBg" value="<?php echo htmlspecialchars($this->_var['order']['email']); ?>" size="25" />
                </td>
              </tr>
              ...
              <tr>
                <td align="left" bgcolor="#ffffff">
				<input name="address" type="text" class="inputBg" value="<?php echo htmlspecialchars($this->_var['order']['address']); ?> " size="25" /><br/>
				<?php echo $this->_var['lang']['detailed_address']; ?>
					 </td>
				 </tr>
				 <tr>
                <td align="left" bgcolor="#ffffff"> 
				<input name="zipcode" type="text"  class="inputBg" value="<?php echo htmlspecialchars($this->_var['order']['zipcode']); ?>" size="25" /><br/>
				<?php echo $this->_var['lang']['postalcode']; ?>
				</td>
              </tr>
              <?php endif; ?>
              <tr>
				...
				<input name="tel" type="text" class="inputBg" value="<?php echo htmlspecialchars($this->_var['order']['tel']); ?>" size="25" /><br/><?php echo $this->_var['lang']['phone']; ?></td>
				</tr>
				 <tr>
                <td  align="left" bgcolor="#ffffff"> 
					 
				<input name="mobile" type="text"  class="inputBg" value="<?php echo htmlspecialchars($this->_var['order']['mobile']); ?>" size="25" /><br/><?php echo $this->_var['lang']['backup_phone']; ?></td>
              </tr>
              <?php if ($this->_var['order']['exist_real_goods']): ?>
              
              <tr>
                <td align="left"  bgcolor="#ffffff"> 
				<input name="sign_building" class="inputBg" type="text" value="<?php echo htmlspecialchars($this->_var['order']['sign_building']); ?>" size="25" /><br/><?php echo $this->_var['lang']['sign_building']; ?>
                </td>
			</tr>	
				 <tr>
                <td  align="left" bgcolor="#ffffff"> 
				...
				<input name="best_time" type="text" class="inputBg" value="<?php echo htmlspecialchars($this->_var['order']['best_time']); ?>" size="25" /><br/><?php echo $this->_var['lang']['deliver_goods_time']; ?>
                </td>
              </tr>
              <?php endif; ?>
              <tr>
                <td colspan="4" align="center" bgcolor="#ffffff"><input type="hidden" name="act" value="save_order_address" />
                  ...
                  <input type="submit" class="c-btn" value="<?php echo $this->_var['lang']['update_address']; ?>"  />
                </td>
              </tr>
            </table>
          </form>
...
?>
              ...
              <input type="hidden" name="order_id" value="<?php echo $this->_var['order']['order_id']; ?>" />
              <input type="submit" name="Submit" class="c-btn" value="<?php echo $this->_var['lang']['button_submit']; ?>" />
              </form>
              <?php endif; ?>
                  </td>
                </tr>
	     ...
	     <header id="header">
			<div class="c-inav">
				<section>
					...
					<section>
					<span style="font-size:14px; color:#333; font-weight:normal"><?php echo $this->_var['lang']['user_balance']; ?></span>
				</section>
				<section></section>
			</div>
		</header>
...
?>
        ...
        <div class="blank"></div>
         <table width="100%" border="0" cellpadding="5" cellspacing="1">
          <tr>
			...
			<a href="user.php?act=account_deposit" class="f6"><?php echo $this->_var['lang']['surplus_type_0']; ?></a> 
			| 
			<a href="user.php?act=account_raply" class="f6"><?php echo $this->_var['lang']['surplus_type_1']; ?></a> 
			| 
			<a href="user.php?act=account_detail" class="f6"><?php echo $this->_var['lang']['add_surplus_log']; ?></a> | <a href="user.php?act=account_log" class="f6"><?php echo $this->_var['lang']['view_application']; ?></a> </td>
          </tr>
        </table>
        <?php endif; ?>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="1" >
          <tr>
            ...
            <td bgcolor="" align="left"><input  placeholder="<?php echo $this->_var['lang']['repay_money']; ?>" type="text" name="amount" value="<?php echo htmlspecialchars($this->_var['order']['amount']); ?>" class="inputBg" size="30" />
            </td>
          </tr>
          <tr>
         
            <td bgcolor="" align="left">
			<textarea placeholder="<?php echo $this->_var['lang']['process_notic']; ?>" name="user_note" cols="55" rows="6"  class="B_blue" ><?php echo htmlspecialchars($this->_var['order']['user_note']); ?></textarea></td>
          </tr>
          <tr>
            ...
            <input type="hidden" name="surplus_type" value="1" />
              ...
              <input type="reset" name="reset" class="c-btn" value="<?php echo $this->_var['lang']['button_reset']; ?>" />
            </td>
          </tr>
        </table>
        </form>
...
?>
        ...
        <input type="hidden" name="surplus_type" value="0" />
          ...
          <input type="reset"  class="c-btn"  name="reset" value="<?php echo $this->_var['lang']['button_reset']; ?>" />
        </td>
      </tr>
          </table>
        </form>
      ...
      <?php if ($this->_var['action'] == 'address_list'): ?>
		...
		<div class="c-inav">
			<section>
				...
				<section>
				<span style="font-size:14px; color:#333; font-weight:normal"><?php echo $this->_var['lang']['consignee_info']; ?></span>
			</section>
			<section></section>
		</div>
		</header>
...
?>
            <form action="user.php" method="post" name="theForm" onsubmit="return checkConsignee(this)" style="padding-bottom:20px;">
              <table width="100%" border="0" cellpadding="5" cellspacing="1" >
                <tr>
               
                  <td align="left" ><select name="country" id="selCountries_<?php echo $this->_var['sn']; ?>" onchange="region.changed(this, 1, 'selProvinces_<?php echo $this->_var['sn']; ?>')">
...
?>
                   ...
                   <div style="color:#f00"><?php echo $this->_var['lang']['country_province']; ?><?php echo $this->_var['lang']['require_field']; ?></div> </td>
                </tr>
                <tr>
                 
                  <td align="left" ><input name="consignee" type="text" class="inputBg" id="consignee_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['consignee']); ?>" /><br/>
                  <?php echo $this->_var['lang']['consignee_name']; ?><?php echo $this->_var['lang']['require_field']; ?>   </td>
                </tr>
                <tr>
                 
                  <td align="left" ><input name="email" type="text" class="inputBg" id="email_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['email']); ?>" />
				 <div style="color:#f00">
                   <?php echo $this->_var['lang']['email_address']; ?><?php echo $this->_var['lang']['require_field']; ?></div> </td>
                </tr>
                <tr>
               
                  <td align="left" ><input name="address" type="text" class="inputBg" id="address_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['address']); ?>" /> <div style="color:#f00">
                  <?php echo $this->_var['lang']['detailed_address']; ?><?php echo $this->_var['lang']['require_field']; ?></div>   </td>
                </tr>
                <tr>
             
                  <td align="left" ><input  placeholder="<?php echo $this->_var['lang']['postalcode']; ?>" name="zipcode" type="text" class="inputBg" id="zipcode_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['zipcode']); ?>" /></td>
                </tr>
                <tr>
       
                  <td align="left" ><input name="tel" type="text" class="inputBg" id="tel_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['tel']); ?>" />
                  <div style="color:#f00"><?php echo $this->_var['lang']['phone']; ?><?php echo $this->_var['lang']['require_field']; ?></div>   </td>
                </tr>
                <tr>
           
                  <td align="left" ><input placeholder="<?php echo $this->_var['lang']['backup_phone']; ?>" name="mobile" type="text" class="inputBg" id="mobile_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['mobile']); ?>" /></td>
                </tr>
                <tr>
 
                  <td align="left" ><input  placeholder="<?php echo $this->_var['lang']['sign_building']; ?>" name="sign_building" type="text" class="inputBg" id="sign_building_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['sign_building']); ?>" />  </td>
                </tr>
                <tr>
          
                  <td align="left" ><input  placeholder="<?php echo $this->_var['lang']['deliver_goods_time']; ?>"  name="best_time" type="text"  class="inputBg" id="best_time_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['best_time']); ?>" /></td>
                </tr>
                <tr>
                 
                  <td align="center"><?php if ($this->_var['consignee']['consignee'] && $this->_var['consignee']['email']): ?>
                    <input type="submit" name="submit"  class="c-btn" value="<?php echo $this->_var['lang']['confirm_edit']; ?>"  style="margin-right:5px;" />
                    <input name="button" type="button"  class="c-btn" style="margin-right:5px;"  onclick="if (confirm('<?php echo $this->_var['lang']['confirm_drop_address']; ?>'))location.href='user.php?act=drop_consignee&id=<?php echo $this->_var['consignee']['address_id']; ?>'" value="<?php echo $this->_var['lang']['drop']; ?>" />
                    <?php else: ?>
                    <input type="submit" name="submit"  class="c-btn"  value="<?php echo $this->_var['lang']['add_address']; ?>"/>
                    <?php endif; ?>
