...
/* 网址 */
$modules[$i]['website'] = 'http://zhen-an.taobao.com';
...
$button .= "<input type='hidden' name='isSend' value='".$payment['alipay_pay_sms']."'>"; //是否勾选免费短信通知收款人
$button .= "<input type='hidden' name='smsNo' value='".$payment['alipay_smsNo']."'>";     //收款人手机号码
$button .= "<input type='submit' value='' style='background:url(/data/images/alipay_twd.png);width:152px;height:27px;border:0;cursor:pointer;'>";
$button .= "</form>";
$button .= '</div>';
