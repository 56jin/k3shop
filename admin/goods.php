...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
	...
	/* 增加代码__限购数与限购日期__start   By www.ecshop120.com */
	$buymax = $_REQUEST['buymax'] ? intval($_REQUEST['buymax']) : 0;
	$buymax_start_date = ($buymax && !empty($_POST['buymax_start_date'])) ? local_strtotime($_POST['buymax_start_date']) : 0;
    $buymax_end_date =  ($buymax && !empty($_POST['buymax_end_date'])) ? local_strtotime($_POST['buymax_end_date']) : 0;
	...
	/* 增加代码__限购数与限购日期__end    By www.ecshop120.com*/
